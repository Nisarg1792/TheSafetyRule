 ...
 * @author admin
 */
public class UpdatePersonMainAdmin extends javax.swing.JPanel {

    /**
     * Creates new form UpdatePersonMainAdmin
     */
    int index;
    JPanel mainJPanel;
    PersonDirectory pd;
    Person p;
    public UpdatePersonMainAdmin(JPanel mainJPanel, PersonDirectory pd, int index) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 420, -1, -1));
        ...
        add(createPersonTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 420, -1, -1));
        ...
        add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 420, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Name");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 99, -1, -1));

        phoneTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(phoneTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 303, 159, -1));

        zipTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(zipTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(496, 260, 85, -1));
        ...
        add(warningLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(366, 307, -1, -1));

        emailTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(emailTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 383, 159, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("View/Update Person");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 37, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Street Address");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 143, -1, -1));

        faxTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(faxTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 343, 159, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Country");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 263, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("State");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 223, -1, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Fax");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 346, -1, -1));

        countryTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(countryTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 260, 159, -1));

        nameTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(nameTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 96, 159, -1));

        stateTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(stateTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 220, 159, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("City");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 180, -1, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Phone");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 306, -1, -1));

        cityTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(cityTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 180, 159, -1));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 80, 734, 10));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("ZipCode");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(366, 263, -1, -1));

        streetAddressTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(streetAddressTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 140, 159, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Email");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 383, -1, -1));
