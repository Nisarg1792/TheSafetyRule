 ...
 * @author admin
 */
public class UpdateAdminCountryAdminMA extends javax.swing.JPanel {

    /**
     * Creates new form UpdateAdminCountryAdminMA
     */
    JPanel mainJPanel;
    Person p;
    CountryAdmin countryAdmin;
    public UpdateAdminCountryAdminMA(JPanel mainJPanel,CountryAdmin countryAdmin) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(countryTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 241, 159, -1));
        ...
        add(zipTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 284, 159, -1));

        userNameTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(userNameTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(559, 77, 159, -1));
        ...
        add(warningLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(397, 405, -1, -1));

        phoneTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(phoneTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 326, 159, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("ZipCode");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 287, -1, -1));

        jLabel15.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Password");
        add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 119, -1, -1));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("UserName");
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 83, -1, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Email");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 404, -1, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Assigned City");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 162, -1, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Update Admin");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 24, -1, -1));

        emailTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(emailTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 401, 159, -1));

        cityTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(cityTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 161, 159, -1));

        assignedContinentTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(assignedContinentTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(559, 159, 159, -1));

        passwordTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(passwordTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(559, 119, 159, -1));

        jSeparator2.setOrientation(javax.swing.SwingConstants.VERTICAL);
        add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(341, 77, 18, 440));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 56, 712, 10));

        faxTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(faxTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 366, 159, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("State");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 204, -1, -1));

        streetAddressTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(streetAddressTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 121, 159, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Country");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 244, -1, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Fax");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 367, -1, -1));

        stateTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(stateTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 201, 159, -1));

        nameTB.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        add(nameTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 77, 159, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("City");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 161, -1, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Phone");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 333, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Street Address");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 124, -1, -1));
