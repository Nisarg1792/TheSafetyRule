 ...
 * @author admin
 */
public class UpdateAdminCountryAdmin extends javax.swing.JPanel {

    /**
     * Creates new form UpdateAdminCountryAdmin
     */
    JPanel mainJPanel;
    StateAdmin stateAdmin;
    Person p;
    public UpdateAdminCountryAdmin(JPanel mainJPanel,StateAdmin stateAdmin) {
        initComponents();
        this.mainJPanel = mainJPanel;
        this.stateAdmin = stateAdmin;
        warningLbl.setVisible(false);
        this.p = stateAdmin.getP();
        setData();
    }
    ...
    private void initComponents() {
        ...
        add(createPersonTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 440, -1, -1));
