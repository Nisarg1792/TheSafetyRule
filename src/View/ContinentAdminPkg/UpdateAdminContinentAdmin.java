 ...
 * @author admin
 */
public class UpdateAdminContinentAdmin extends javax.swing.JPanel {

    /**
     * Creates new form UpdateAdminContinentAdmin
     */
    JPanel mainJPanel;
    CountryAdmin countryAdmin;
    Person p;
    public UpdateAdminContinentAdmin(JPanel mainJPanel,CountryAdmin countryAdmin) {
        initComponents();
    ...
    void setData(){
        ...
        userNameTB.setText(countryAdmin.getUserAccount().getUserName());
        passwordTB.setText(countryAdmin.getUserAccount().getPassword());
        assignedContinentTB.setText(countryAdmin.getCountry().getLocation().getValue());
    ...
    private void initComponents() {
        ...
        add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 430, -1, -1));
        ...
        add(createPersonTB, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 430, -1, -1));
    ...
    private void createPersonTBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createPersonTBActionPerformed
        ...
        if(validateFields()){
            ...
            countryAdmin.updateAdmin(p, userNameTB.getText(), passwordTB.getText(), assignedContinentTB.getText());
