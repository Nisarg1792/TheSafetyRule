...
public class BloodEventJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 50, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("What type of blood product was involved in the event or unsafe condition?");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 95, 426, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Which of the following best characterizes the event?");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 134, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("What incorrect action was involved in administering the blood or blood product?");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 173, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("During which stage was the event discovered ?");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 212, -1, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("During which stage did the event originate ?");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 251, -1, -1));

        involvedCB.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        add(involvedCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(502, 93, 366, -1));
        ...
        add(charCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(502, 132, 366, -1));
        ...
        add(actionCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(502, 171, -1, -1));

        discoverCB.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        add(discoverCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(502, 210, 366, -1));

        originCB.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        add(originCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(502, 249, 366, -1));
        ...
        add(approveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 410, -1, -1));
        ...
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 410, -1, -1));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 81, 426, 10));
