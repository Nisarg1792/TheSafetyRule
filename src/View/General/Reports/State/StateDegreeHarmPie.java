 ...
 * @author admin
 */
public class StateDegreeHarmPie extends javax.swing.JPanel {

    /**
     * Creates new form StateDegreeHarmPie
     */
    JPanel mainJPanel;
    StateComplaints cc;
    int Death=0,Severeharm=0,Moderateharm=0,Mildharm=0,Noharm=0;
    JFreeChart chart;
    public StateDegreeHarmPie(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateDegreeHarmPie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
