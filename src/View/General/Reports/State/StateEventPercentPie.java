 ...
 * @author admin
 */
public class StateEventPercentPie extends javax.swing.JPanel {

    /**
     * Creates new form StateEventPercentPie
     */
    JPanel mainJPanel;
    StateComplaints cc;
    ...
    JFreeChart chart;
    public StateEventPercentPie(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateEventPercentPie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
