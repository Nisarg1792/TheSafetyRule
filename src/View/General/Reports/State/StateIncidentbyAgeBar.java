 ...
 * @author admin
 */
public class StateIncidentbyAgeBar extends javax.swing.JPanel {

    /**
     * Creates new form StateIncidentbyAgeBar
     */
    JPanel mainJPanel;
    StateComplaints cc;
    String key = "";
    ...
    JFreeChart chart;
    public StateIncidentbyAgeBar(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateIncidentAgeBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
