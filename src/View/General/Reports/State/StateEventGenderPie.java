 ...
 * @author admin
 */
public class StateEventGenderPie extends javax.swing.JPanel {

    /**
     * Creates new form StateEventGenderPie
     */
    JPanel mainJPanel;
    StateComplaints cc;
    int male=0, female = 0;
    JFreeChart chart;
    public StateEventGenderPie(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
