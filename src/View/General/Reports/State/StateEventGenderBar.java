 ...
 * @author admin
 */
public class StateEventGenderBar extends javax.swing.JPanel {

    /**
     * Creates new form StateEventGenderBar
     */
    JPanel mainJPanel;
    StateComplaints cc;
    String key = "";
    ...
    HashMap male,female;
    JFreeChart chart;
    public StateEventGenderBar(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
    ...
    protected static BufferedImage draw(JFreeChart chart, int width, int height)
    {
     ...
     private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        chart = ChartFactory.createBarChart(
            ...
            "Gender-State",               // domain axis label
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateEventGenderBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
