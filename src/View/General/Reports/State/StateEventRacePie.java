 ...
 * @author admin
 */
public class StateEventRacePie extends javax.swing.JPanel {

    /**
     * Creates new form StateEventRacePie
     */
    JPanel mainJPanel;
    StateComplaints cc;
    int AmericanIndian=0,Asian=0,Black=0,NativeHawaiian=0,White=0,More=0;
    JFreeChart chart;
    public StateEventRacePie(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateEventRacePie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
