 ...
 * @author admin
 */
public class StateEventPercentBar extends javax.swing.JPanel {

    /**
     * Creates new form StateEventPercentBar
     */
    JPanel mainJPanel;
    StateComplaints cc;
    String key = "";
    ...
    JFreeChart chart;
    public StateEventPercentBar(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
    ...
    protected static BufferedImage draw(JFreeChart chart, int width, int height)
    {
     ...
     private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        chart = ChartFactory.createBarChart(
            "State Event Wise Bar Chart",         // chart title
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateEventPercentageBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
