 ...
 * @author admin
 */
public class StateIncidentbyAgePie extends javax.swing.JPanel {

    /**
     * Creates new form StateIncidentbyAgePie
     */
    JPanel mainJPanel;
    StateComplaints cc;
    int neo=0,infant=0,child=0,adol=0,adult=0,mature=0,old=0,aged=0;
    JFreeChart chart;
    public StateIncidentbyAgePie(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateIncidentByAgePie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
