 ...
 * @author admin
 */
public class StateDegreeHarmBar extends javax.swing.JPanel {

    /**
     * Creates new form StateDegreeHarmBar
     */JPanel mainJPanel;
    StateComplaints cc;
    String key = "";
    ...
    JFreeChart chart;
    public StateDegreeHarmBar(JPanel mainJPanel,StateComplaints cc) {
        initComponents();
        death = new HashMap();
    ...
    void setData(){
     ...
     private CategoryDataset createDataset(){
         ...
         Integer num;
         for (Object key : death.keySet()) {
		num = (Integer)death.get(key);
             dataset.addValue(num.intValue(), "Death", (String)key);
	 }
     ...
     private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        chart = ChartFactory.createBarChart(
            "Degree of Harm-State",         // chart title
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "StateDegreeHarmBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
