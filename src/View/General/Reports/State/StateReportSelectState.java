 ...
 * @author admin
 */
public class StateReportSelectState extends javax.swing.JPanel {

    /**
     * Creates new form StateReportSelectState
     */
    JPanel mainJPanel;
    ...
    public StateReportSelectState(JPanel mainJPanel,MasterAccountsDirectory mad) {
        initComponents();
        this.mad = mad;
    ...
    private void stateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stateBtnActionPerformed
        ...
        StateSelectReportType s = new StateSelectReportType(mainJPanel, stateAdmin.getStatecomplaints());
        mainJPanel.add("Guest View Reports available State.", s);
