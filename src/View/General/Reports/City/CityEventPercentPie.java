 ...
 * @author admin
 */
public class CityEventPercentPie extends javax.swing.JPanel {

    /**
     * Creates new form CityEventPercentPie
     */
    JPanel mainJPanel;
    CityComplaints cc;
    ...
    JFreeChart chart;
    public CityEventPercentPie(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
    ...
    void setData(){
        ...
        for(BloodEvent evt : c.getBloodEvents()){
            switch(evt.getBc().getEventReported()){
                case "Incident":
                    Incident++;
                    break;
                case "Near Miss":
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CityEventPercentPie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
