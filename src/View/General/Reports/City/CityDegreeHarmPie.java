 ...
 * @author admin
 */
public class CityDegreeHarmPie extends javax.swing.JPanel {

    /**
     * Creates new form CityDegreeHarmPie
     */
    JPanel mainJPanel;
    CityComplaints cc;
    int Death=0,Severeharm=0,Moderateharm=0,Mildharm=0,Noharm=0;
    JFreeChart chart;
    public CityDegreeHarmPie(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
