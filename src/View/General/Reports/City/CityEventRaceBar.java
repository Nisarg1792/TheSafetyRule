 ...
 * @author admin
 */
public class CityEventRaceBar extends javax.swing.JPanel {

    /**
     * Creates new form CityEventRaceBar
     */
    JPanel mainJPanel;
    CityComplaints cc;
    String key = "";
    ...
    JFreeChart chart;
    public CityEventRaceBar(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CityEventRaceBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
