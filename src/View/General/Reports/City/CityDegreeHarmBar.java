 ...
 * @author admin
 */
public class CityDegreeHarmBar extends javax.swing.JPanel {

    /**
     * Creates new form CityDegreeHarmBar
     */JPanel mainJPanel;
    CityComplaints cc;
    String key = "";
    ...
    JFreeChart chart;
    public CityDegreeHarmBar(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
        death = new HashMap();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CityDegreeHarmBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
