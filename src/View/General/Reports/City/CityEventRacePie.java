 ...
 * @author admin
 */
public class CityEventRacePie extends javax.swing.JPanel {

    /**
     * Creates new form CityEventRacePie
     */
    JPanel mainJPanel;
    CityComplaints cc;
    int AmericanIndian=0,Asian=0,Black=0,NativeHawaiian=0,White=0,More=0;
    JFreeChart chart;
    public CityEventRacePie(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CityEventRacePie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
