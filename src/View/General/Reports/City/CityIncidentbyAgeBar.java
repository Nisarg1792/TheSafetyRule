 ...
 * @author admin
 */
public class CityIncidentbyAgeBar extends javax.swing.JPanel {

    /**
     * Creates new form CityIncidentbyAgeBar
     */
    JPanel mainJPanel;
    CityComplaints cc;
    String key = "";
    ...
    JFreeChart chart;
    public CityIncidentbyAgeBar(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CityIncidentAgeBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
