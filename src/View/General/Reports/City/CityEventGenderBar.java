 ...
 * @author admin
 */
public class CityEventGenderBar extends javax.swing.JPanel {

    /**
     * Creates new form CityEventGenderBar
     */
    JPanel mainJPanel;
    CityComplaints cc;
    String key = "";
    ...
    HashMap male,female;
    JFreeChart chart;
    public CityEventGenderBar(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CityEventGenderBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
