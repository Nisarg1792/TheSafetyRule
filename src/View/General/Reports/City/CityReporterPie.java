 ...
 * @author admin
 */
public class CityReporterPie extends javax.swing.JPanel {

    /**
     * Creates new form CityReporterPie
     */
    JPanel mainJPanel;
    CityComplaints cc;
    int doctor=0, nurse=0, pharma=0,allied=0, healthcare=0,emergency=0,patient=0;
    JFreeChart chart;
    public CityReporterPie(JPanel mainJPanel,CityComplaints cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CityReporterPie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
