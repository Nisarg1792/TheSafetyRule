 ...
 * @author admin
 */
public class CountryEventPercentBar extends javax.swing.JPanel {

    /**
     * Creates new form CountryEventPercentBar
     */
    JPanel mainJPanel;
    CountryComplaint cc;
    String key = "";
    ...
    JFreeChart chart;
    public CountryEventPercentBar(JPanel mainJPanel,CountryComplaint cc) {
        initComponents();
    ...
    protected static BufferedImage draw(JFreeChart chart, int width, int height)
    {
     ...
     private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        chart = ChartFactory.createBarChart(
            "Country Event Wise Bar Chart",         // chart title
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CountryEventPercentageBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
