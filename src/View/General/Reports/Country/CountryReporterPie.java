 ...
 * @author admin
 */
public class CountryReporterPie extends javax.swing.JPanel {

    /**
     * Creates new form CountryReporterPie
     */
    JPanel mainJPanel;
    CountryComplaint cc;
    int doctor=0, nurse=0, pharma=0,allied=0, healthcare=0,emergency=0,patient=0;
    JFreeChart chart;
    public CountryReporterPie(JPanel mainJPanel,CountryComplaint cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CountryReporterPie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
