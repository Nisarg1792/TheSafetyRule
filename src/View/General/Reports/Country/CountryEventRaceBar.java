 ...
 * @author admin
 */
public class CountryEventRaceBar extends javax.swing.JPanel {

    /**
     * Creates new form CountryEventRaceBar
     */
    JPanel mainJPanel;
    CountryComplaint cc;
    String key = "";
    ...
    JFreeChart chart;
    public CountryEventRaceBar(JPanel mainJPanel,CountryComplaint cc) {
        initComponents();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CountryEventRaceBar" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
