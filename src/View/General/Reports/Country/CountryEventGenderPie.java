 ...
 * @author admin
 */
public class CountryEventGenderPie extends javax.swing.JPanel {

    /**
     * Creates new form CountryEventGenderPie
     */
    JPanel mainJPanel;
    CountryComplaint cc;
    int male=0, female = 0;
    JFreeChart chart;
    public CountryEventGenderPie(JPanel mainJPanel,CountryComplaint cc) {
        initComponents();
