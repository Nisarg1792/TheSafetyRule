 ...
 * @author admin
 */
public class CountryEventPercentPie extends javax.swing.JPanel {

    /**
     * Creates new form CountryEventPercentPie
     */
    JPanel mainJPanel;
    CountryComplaint cc;
    int Incident=0,NearMiss=0,Unsafe=0;


    JFreeChart chart;
    public CountryEventPercentPie(JPanel mainJPanel,CountryComplaint cc) {
        initComponents();
    ...
    void setChart(){
        ...
        chart = createChart(dataset, "Event Percentage");       
                ...
                for(CityComplaints cityC : s.getStateComplaintList()){
                  Complaint c = cityC.getComplaints();
                    for(BloodEvent evt : c.getBloodEvents()){
                        setValue(evt.getBc().getEventReported()); 
                    }
    ...
    private PieDataset createDataset() {
        ...
        dataset.setValue("Incident", new Double(Incident));
        dataset.setValue("Near Miss", new Double(NearMiss));
        dataset.setValue("Unsafe Condition", new Double(Unsafe));
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try{
            String filename = "CountryEventPercentPie" + dateFormat.format(cal.getTime()).toString().trim() + "jpg";
